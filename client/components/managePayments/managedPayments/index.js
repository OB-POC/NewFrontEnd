...
export default class Rel extends React.Component{
  ...
  onNextClick = () => {
    this.props.history.push('./managePaymentsSucceed')
  }
            ...
            <div style = {{display:"flex"}}>
              ...
              <div className='main-content' style = {{backgroundColor:"#f5f6fa",width:"94.5%",paddingBottom:'20px'}}>
                ...
                <div className = 'managePaymentsModal'>
                    ...
                    We’ve found that you have insufficient funds in the RBS account to pay off the upcoming Standing instruction.
                    <br/>
                    <br/>
                    We recommend transferring £ 100 from Munzo acoount to RBS account. 
                    </div>
