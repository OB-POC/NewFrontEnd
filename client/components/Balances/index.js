            ...
            <div>
                ...
                <Paper className='paper' zDepth={2} style = {{padding:'20px',width: '50%'}}>
                   ...
                   <div className='detail-credit'>
                        ...
                        <small className='credit' style={{color:'#ff5d64',whiteSpace: 'nowrap'}}><i className='fas fa-info-circle'></i> Card payment in 3 days</small></p>
                   </div>
                   <div className='name-credit'><p>CC</p></div>
                    <div className='line'></div>
                   <div className='amount-credit'><h5><b style={{color:'#ff5d64',whiteSpace: 'nowrap'}}><span>&#163;</span> 2800</b></h5></div>
                   </div>
                   <div className='outer-layer' style={{display:'flex'}}>
                   <div className='img-credit'><img src='../../../../images/card_img1.jpg' /></div>
                   <div className='detail-credit'>
                        ...
                        <small className='credit' style={{color:'#ff5d64',whiteSpace: 'nowrap'}}>Card payment in 3 days</small></p>
                   </div>
                   <div className='name-credit'><p>CC</p></div>
                    <div className='line'></div>
                   <div className='amount-credit'><h5><b style={{color:'#ff5d64',whiteSpace: 'nowrap'}}><span>&#163;</span> 2800</b></h5></div>
                ...
                <div className='outer-layer2' style={{display:'flex'}}>
                   ...
                   <div className='amount-credit'><h5><b style={{color:'#4a4a4a',whiteSpace: 'nowrap'}}><span>&#163;</span> 2800</b></h5></div>
                   </div>
                   <div className='outer-layer2' style={{display:'flex'}}>
                   <div className='img-credit'><img src='../../../../images/card_img2.jpg' /></div>
                   <div className='detail-credit'>
